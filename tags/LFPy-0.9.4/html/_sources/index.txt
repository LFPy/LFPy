...
`International Neuroinformatics Coordinating Facility <http://incf.org>`_ (`INCF <http://incf.org>`_), `The Research Council of Norway <http://www.forskningsradet.no/english/>`_ (eScience, NevroNor) and `EU-FT7 (BrainScales) <http://www.brainscales.org>`_.
